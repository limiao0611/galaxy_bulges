...
#  fields = ['number_density','temperature','pressure','z-velocity']#,'CR_Energy_Density','z_den_flux']
  ...
  fields = ['number_density','temperature','entropy','mach_number']#,'CR_Energy_Density','z_den_flux']
  fields = ['number_density','temperature','cooling_time','mach_number']#,'CR_Energy_Density','z_den_flux']
