...
def _dotM(field, data):
    return data['density']*4*3.1415926* data['radial_velocity']*data['radius']**2
...
yt.add_field('dotM',function=_dotM,units="msun/yr")
num=range(1,260,20)
#num=[1,100,200]
for i in num:
    see(i)
