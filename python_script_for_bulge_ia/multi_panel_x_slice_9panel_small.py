...
#  fields = ['number_density','temperature','pressure','z-velocity']#,'CR_Energy_Density','z_den_flux']
  ...
  fields = ['number_density','temperature','pressure','mach_number']#,'CR_Energy_Density','z_den_flux']
  fields = ['number_density','temperature','pressure','entropy','mach_number','SN_Colour','cooling_time','radial_velocity', 'z-velocity' ]#,'CR_Energy_Density','z_den_flux']
...
#  p.set_zlim('entropy',5,200)
  ...
  p.annotate_timestamp(corner='upper_left',time_unit='Myr',text_args={'color':'black'})
  if yt.is_root():
     plt.savefig('multi_x_slice_9panel_small_'+str(i)+'.png')
